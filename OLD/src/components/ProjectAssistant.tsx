...
import type { Project } from '@/components/projects/types'; // Module partagé, garder @/
import { findProjectCandidates } from '@/lib/utils/findProjectCandidates'; // Module partagé, garder @/
import { generateNoteFromContent } from '@old/lib/assistant/parsers/note-generator';
