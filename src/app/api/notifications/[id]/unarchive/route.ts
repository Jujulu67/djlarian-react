...
export async function PATCH(
  ...
  try {
    ...
    return createSuccessResponse(serialized, 200, 'Notification désarchivée');
  } catch (error) {
    return handleApiError(error, 'PATCH /api/notifications/[id]/unarchive');
  }
}
