      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 font-montserrat max-w-2xl mx-auto">
            Une question ? Une proposition de collaboration ? N'hésitez pas à me
            contacter.
          </p>
        </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label
                  htmlFor="name"
                  className="block text-sm font-montserrat mb-2"
                >
                  Nom
                </label>
                <input
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-300">
                Pour les demandes professionnelles, veuillez contacter mon
                manager :
              </p>
              <a
