...
const events: Event[] = [
  ...
  },
  {
    ...
    description:
      "Une soirée intime avec un set exclusif de nouvelles productions.",
  ...
  },
  {
    ...
    description:
      "Festival en plein air avec une vue imprenable sur la Méditerranée.",
...
export default function EventsPage() {
  ...
  const filteredEvents =
    filter === "all" ? events : events.filter((event) => event.isFeatured);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 font-montserrat max-w-2xl mx-auto">
            Retrouvez-moi lors de ces événements exceptionnels pour des
              ...
              <div className="relative overflow-hidden rounded-lg bg-purple-900/20">
                <div className="aspect-[16/9]">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                    <h3 className="text-2xl font-audiowide mb-2">
                      {event.title}
                    </h3>
