...
export default function AdminEventsPage() {
  ...
  const filteredEvents = useMemo(() => {
    ...
    return eventsArray.filter((event) => {
      ...
      return matchesSearch && matchesStatus && matchesPublish && matchesFeatured;
    });
  }, [events, searchTerm, statusFilter, publishFilter, featuredFilter]);
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-8 bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-xl p-5 shadow-xl">
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="flex flex-wrap md:flex-nowrap gap-3 w-full md:w-2/3 justify-end">
              {/* Filtre par statut */}
              <select
