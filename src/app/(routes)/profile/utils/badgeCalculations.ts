...
export function calculateBadges(
  ...
  const badges: Badge[] = [
    ...
    // Badge nouveau membre
    {
      ...
      icon: Sparkles,
      image: '/images/badges/newcomer.png',
    ...
    // Badge premier projet
    {
      ...
      icon: Rocket,
      image: '/images/badges/first-project.png',
    ...
    // Badge productif (5 projets)
    {
      ...
      hint: 'Crée 5 projets',
      icon: Zap,
      image: '/images/badges/productive.png',
    ...
    // Badge maître (10 projets)
    {
      ...
      icon: Gem,
      image: '/images/badges/master.png',
    ...
    // Badge finisseur (1 projet terminé)
    {
      ...
      icon: CheckCircle2,
      image: '/images/badges/finisher.png',
    ...
    // Badge Game Explorer - A joué au jeu easter egg
    {
      ...
      icon: Gamepad2,
      image: '/images/badges/game-explorer.png',
    ...
    // Badge Pro Gamer - 500 points
    {
      ...
      icon: Trophy,
      image: '/images/badges/pro-gamer.png',
    ...
    // Badge Casino Explorer - A découvert le casino
    {
      ...
      icon: Dices,
      image: '/images/badges/casino-explorer.png',
