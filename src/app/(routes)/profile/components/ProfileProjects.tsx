...
export function ProfileProjects({
  ...
  if (projects === 0) {
    return (
      ...
      >
        <div className="glass-modern glass-modern-hover rounded-2xl p-4 sm:p-6 lg:p-4 lift-3d h-full">
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <div className="glass-modern glass-modern-hover rounded-2xl p-3 sm:p-4 lg:p-3 lift-3d h-full flex flex-col">
