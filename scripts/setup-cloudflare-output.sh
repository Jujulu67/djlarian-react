...
if [ -f ".open-next/worker.js" ]; then
  ...
  # Avec Prisma Client Edge, les polyfills complexes ne sont plus nécessaires
  # Le client Edge n'utilise pas de binaires natifs et ne nécessite pas fs.readdir
...
# Avec Prisma Client Edge, les polyfills complexes ne sont plus nécessaires
# Le client Edge n'utilise pas de binaires natifs
echo "✅ Configuration server-functions (Prisma Client Edge ne nécessite pas de polyfills)"
