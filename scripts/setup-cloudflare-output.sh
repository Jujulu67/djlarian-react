...
if [ -f ".open-next/worker.js" ]; then
  ...
  awk '
    BEGIN {
      ...
      print "  };"
      print "  patchUnenv();"
      print "  // Patcher plusieurs fois au cas où unenv serait chargé plus tard"
      print "  if (typeof setTimeout !== \"undefined\") {"
      print "    setTimeout(patchUnenv, 0);"
      print "    setTimeout(patchUnenv, 10);"
      print "    setTimeout(patchUnenv, 100);"
      print "  }"
      print "}"
      print ""
    }
